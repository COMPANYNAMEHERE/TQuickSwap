...
public final class LangHelper {
    ...
    public static void ensureLanguageAvailable(MinecraftServer server, String languageCode) {
        ...
        ResourceLocation loc = ResourceLocation.fromNamespaceAndPath(TQuickSwap.MODID, "lang/" + normalized + ".json");
    ...
    private static Map<String, String> loadEnglish() {
        ...
        ResourceLocation loc = ResourceLocation.fromNamespaceAndPath(TQuickSwap.MODID, "lang/en_us.json");
